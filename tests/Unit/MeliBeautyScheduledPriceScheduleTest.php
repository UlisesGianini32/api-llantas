...
{
    public function test_scheduler_requires_all_three_flags(): void
    {
        foreach ([
            ...
            [true, true, true, true],
        ] as [$enabled, $promotionalEnabled, $schedulerEnabled, $expected]) {
            config()->set('meli_price_manager.beauty_scheduled_prices.enabled', $enabled);
            config()->set('meli_price_manager.beauty_scheduled_prices.promotional_prices_enabled', $promotionalEnabled);
