...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('meli_claim_action_logs', function (Blueprint $table): void {
            ...
            $table->string('telegram_user_id', 64)->nullable()->after('telegram_chat_id')->index();
    ...
    public function down(): void
    {
        Schema::table('meli_claim_action_logs', function (Blueprint $table): void {
            ...
            $table->dropColumn(['telegram_chat_id', 'telegram_user_id', 'reconciled_at', 'reconciliation_result']);
        });
