        ...
        <AppShell title="Borradores ML de Autopartes">
            ...
            <div className="space-y-6">
                <div className="flex flex-col justify-between gap-3 lg:flex-row lg:items-center">
                    ...
                    <div className="flex flex-wrap gap-2"><Link href="/autopartes/mercado-libre/publicaciones" className="rounded-xl border border-rose-300 px-4 py-2 text-sm font-semibold text-rose-700 dark:border-rose-500/40 dark:text-rose-300">Publicaciones controladas</Link><Link href="/autopartes/medios" className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold dark:border-neutral-700">Medios</Link><Link href="/autopartes/precios" className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold dark:border-neutral-700">Precios</Link><Link href="/autopartes/mercado-libre/categorias" className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold dark:border-neutral-700">Categorías ML</Link></div>
                </div>
